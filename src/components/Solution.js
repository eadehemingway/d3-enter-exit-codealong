...
export class App extends React.Component {
  ...
  fillRandomly = () => {
    const newVals = this.state.inputValues.map(v =>
    ...
    return (
      <section>
            ...
            <div id="input-container">
              {inputValues.map((input, i) => (
                <input
                  type="text"
                  key={i}
                  className="input-box node-inputs"
                  value={input}
                  onChange={e => this.changeInput(e.target.value, i)}
                />
              ))}
            </div>
            <button
              id="fill"
              className="fill-input-btn"
              onClick={this.fillRandomly}
            >
              FILL RANDOMLY
            </button>
          </div>
        ...
        <div className="button-container">
          <button id="add" className="add-input-btn" onClick={this.addInput}>
            +
          </button>
          <button
            id="exit"
            className="delete-input-btn red-border"
            onClick={this.removeInput}
          >
            -
          </button>
          <button id="update" className="update-input-btn" onClick={this.draw}>
            UPDATE
          </button>
        </div>
      </section>
